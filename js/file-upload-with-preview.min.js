//https://unpkg.com/file-upload-with-preview@4.1.0/dist/file-upload-with-preview.min.js
              ...
              (i._invoke = (function (A, e, t) {
                ...
                return function (n, i) {
                  ...
                  for (t.method = n, t.arg = i; ; ) {
                    ...
                    "throw" === r.type &&
                      ((g = s), (t.method = "throw"), (t.arg = r.arg));
                  }
                };
              })(A, t, B)),
              i
            ...
            (A.mark = function (A) {
              return (
                Object.setPrototypeOf
                  ...
                  : ((A.__proto__ = h), r(A, E, "GeneratorFunction")),
            ...
            (J.prototype = {
              ...
              finish: function (A) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                  ...
                  if (t.finallyLoc === A)
                    return this.complete(t.completion, t.afterLoc), k(t), c;
                }
              },
              catch: function (A) {
                for (var e = this.tryEntries.length - 1; e >= 0; --e) {
              ...
              if (0 !== A.length) {
                ...
                this.options.maxFileCount > 0 &&
                  A.length + this.cachedFileArray.length >
                    this.options.maxFileCount &&
                  (e = this.options.maxFileCount - this.cachedFileArray.length),
                  this.input.multiple
